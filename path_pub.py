...
class PathPlanner:
    ...
    def map_callback(self, msg):
        ...
        self.map_max = (msg.info.origin.position.x + msg.info.width*msg.info.resolution, msg.info.origin.position.y + msg.info.height*msg.info.resolution)
        self.map_shape = (int(round((self.map_max[0] - self.map_min[0]) / self.map_res)), int(round((self.map_max[1] - self.map_min[1]) / self.map_res)))
